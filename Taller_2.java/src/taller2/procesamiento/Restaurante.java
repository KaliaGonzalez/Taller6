...
public class Restaurante {
	...
	public static void cargarInformacionRestaurante(File archivoIngredientes, File archivoMenu, File archivoCombos) throws FileNotFoundException, IOException, IngredienteRepetidoException, ProductoRepetidoException
	{
	...
	private static void cargarMenu(File archivoMenu) throws ProductoRepetidoException
	{
	...
	public static void iniciarPedido(String nombreCliente, String direccionCliente) throws IOException, ValorException{
